          ...
          <ul class="navbar-nav">
            ...
            <form method="post" action="achat.php" class="item nav-link2">
             ...
             <li class="nav-item"><a class="nav-link2" href="loginvendeur.php"><strong>Vendre</strong></a></li>
              <li class="nav-item"><a class="nav-link2" href="votrecompte.php"><strong>Votre Compte</strong></button></a></li>
...
<footer class="page-footer text-center"> 
    <div id="nav">
            <a class="link" href="categorie.php">Catégorie |</a>
            <a class="link" href="achat.php">Achat |</a>
            <a class="link" href="loginvendeur.php">Vendre |</a>
            <a class="link" href="votrecompte.php">Votre compte |</a>
            <a class="link" href="panier.php">Panier |</a>
