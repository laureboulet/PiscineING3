      ...
      <div class="col-lg-9">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card h-100">
                    ...
                    <div class="card-footer">
                      ...
                      <a href="apercuenchere.php?iditem=<?php echo $data['Iditem']; ?>&hello=true" class="list-group-item">Accéder à l'enchère</a>
                    </div>
                  </div><?php } ?>
                </div>
          <?php
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card h-100">
                    ...
                    <div class="card-footer">
                      <?php echo $data['Categorie'];?><br>
                      <small class="text-muted"><?php echo $data['Typeachat'];?></small>
                      <a href="apercuoffre.php?iditem=<?php echo $data['Iditem']?>" class="list-group-item">Voir les offres</a>
                    </div>
                  </div><?php } ?>
                </div>
          <?php
        ...
        <div class="row">
            ...
            foreach ($stack as $it) {
              ...
              $sql = "SELECT * FROM item WHERE Iditem = $iditem AND Typeachat = 'Achat immédiat'";
