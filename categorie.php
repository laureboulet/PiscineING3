      ...
      <div class="collapse navbar-collapse" id="main-navigation">
          <ul class="navbar-nav">
            ...
            <form method="post" action="achat.php" class="item nav-link2">
              ...
              <li class="nav-item"><a class="nav-link2" href="#"><strong>Votre compte</strong></a></li>
              <li class="nav-item"><a class="nav-link2" href="#"><img src="panier.png" alt="Logo" width="65" height="45"/></a></li> 
    ...
    <div class="row"> 
      <div class="col-lg-3">
        <div class="list-group" style="padding-top: 30px">
          <form method="post" action="categorie.php" class="item">
              <input class="list-group-item" type="submit" name="ferraille" value="Ferraille ou Trésor">
              <input class="list-group-item" type="submit" name="musee" value="Bon pour le Musée">
              <input class="list-group-item" type="submit" name="accessoire" value="Accessoire VIP">
          </form>
        </div>
      </div>
      <!-- /.col-lg-3 -->
      <div class="col-lg-9" style="padding-top: 30px">
        <div class="row">
        <?php
        if(isset($_POST['ferraille'])){
          if ($db_found) {
            $sql = "SELECT * FROM item WHERE Categorie LIKE 'Ferraille ou Trésor'"; 
        ...
        if(isset($_POST['accessoire'])){
          if ($db_found) {
            $sql = "SELECT * FROM item WHERE Categorie LIKE 'Accessoire VIP'"; 
            $result = mysqli_query($db_handle, $sql);
            if (mysqli_num_rows($result) == 0) {
              echo "Pas d'item à vendre."; 
            } 
        ...
        if(isset($_POST['musee'])){
          if ($db_found) {
            $sql = "SELECT * FROM item WHERE Categorie LIKE 'Bon pour le Musée'"; 
            $result = mysqli_query($db_handle, $sql);
            if (mysqli_num_rows($result) == 0) {
              echo "Pas d'item à vendre."; 
            } 
