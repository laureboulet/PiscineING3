...
<body>
  ...
  <p style="text-align: center; font-size: 25px"><strong>Créez votre compte en quelques cliques et accédez aux plus belles trouvailles du marché</strong><p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12" style="font-size: 18px">
